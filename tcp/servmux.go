...
// ServeMux provides mappings from a  commond endpont to handlers by request path.
...
func (mux *ServeMux) ServeLevis(l *net.TCPConn, a *net.TCPAddr, m *levis.Message) *levis.Message {
...
func (mux *ServeMux) HandleFunc(f func(l *net.TCPConn, a *net.TCPAddr, m *levis.Message) *levis.Message) {
